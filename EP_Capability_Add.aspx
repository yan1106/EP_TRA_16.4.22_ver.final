...
<body>
    ...
    <legend class="legend" style="font-weight: 700; font-size: large;">Capability Information</legend> 
      <table> 
        ...
        <asp:GridView ID="GD_CAP" runat="server" AutoGenerateColumns="False" ForeColor="#333333" CellPadding="4" GridLines="None" OnRowCommand="GD_CAP_RowCommand" OnSelectedIndexChanged="GD_CAP_SelectedIndexChanged" OnRowDeleting="GD_CAP_RowDeleting1" OnRowUpdating="GD_CAP_RowUpdating"
            >
         ...
         <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
            ...
            <ItemTemplate>
                <asp:ImageButton ID="ImageButton_View" runat="server"  ImageUrl="icon/view.jpg"  CommandName="View" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                <asp:ImageButton ID="ImageButton2_Update" runat="server" ImageUrl="icon/update.jpg"  CommandName="Update"  CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"/>
                <asp:ImageButton ID="ImageButton3_Delete" runat="server" ImageUrl="icon/delete.jpg"  CommandName="Delete" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" OnClientClick="return confirm('是否刪除？');" />
            </ItemTemplate>
           </asp:TemplateField>
